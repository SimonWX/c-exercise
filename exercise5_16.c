...
int exercise5_16(void){
    ...
    printf("That pace corresponds to running a mile in %d min，", mmin); // correspond vi.相应
    printf("%d sec.\nYour average speed was %1.2f mph.\n", msec, rate); // mph：miles per hour
    return 0;
}
